...
@section('content')
    <div class="mx-auto max-w-screen-xl">
        ...
        <div id="reservations" class="mt-12">
            <div class="flex align-middle justify-center">
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <p class="my-2 mx-8  p-2 font-car font-bold text-gray-600 text-lg ">Owner</p>
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <hr>
            </div>
                ...
                <table class="w-full whitespace-no-wrap overflow-scroll table-auto text-center">
                    <thead>
                        <tr
                            ...
                            <th class="text-center px-4 py-3">owner</th>
                            <th class="text-center px-4 py-3">owner</th>
...
<div id="reservations" class="mt-12">
    <div class="flex align-middle justify-center">
        <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
        <p class="my-2 mx-8  p-2 font-car font-bold text-gray-600 text-lg ">Drivers</p>
        <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
        <hr>
    </div>
    ...
    <div class="w-full overflow-x-auto">
        <table class="w-full whitespace-no-wrap overflow-scroll table-auto text-center">
            <thead>
                <tr
                    class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <th class="text-center px-4 py-3">Driver</th>
                    <th class="text-center px-4 py-3 w-48">Name</th>
                    <th class="text-center px-4 py-3 w-24">Email</th>
                    <th class="text-center px-4 py-3 w-24">Joined at</th>
                    <th class="text-center w-56 px-4 py-3">Reservations</th>
...
<div id="reservations" class="mt-12">
    <div class="flex align-middle justify-center">
        <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
        <p class="my-2 mx-8  p-2 font-car font-bold text-gray-600 text-lg ">Uers</p>
        <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
        <hr>
    </div>
    ...
    <div class="w-full overflow-x-auto">
        <table class="w-full whitespace-no-wrap overflow-scroll table-auto text-center">
            <thead>
                <tr
                    class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <th class="text-center px-4 py-3">User</th>
                    <th class="text-center px-4 py-3 w-48">Name</th>
                    <th class="text-center px-4 py-3 w-24">Email</th>
                    <th class="text-center px-4 py-3 w-24">Joined at</th>
                    <th class="text-center w-56 px-4 py-3">Reservations</th>
