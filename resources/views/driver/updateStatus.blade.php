...
<body>
    <div class="bg-gray-200 flex justify-center items-center h-screen">
        <div class="bg-white p-6 rounded-md md:w-1/3 w-full mx-4">
            ...
            <div>
                <form action="{{ route('tripstatus', ['reservation' => $reservation->id]) }}" method="POST">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="flex justify-center mt-12">
                        <a href="{{ route('driver.trip') }}" class="p-3 w-full text-white text-center rounded-md me-2 bg-red-600 hover:bg-red-800" ><button >Cancel</button></a>
