...
<body class="bg-sec-400">
                            ...
                            <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                <li>
                                    ...
                                    <a href="{{ route('driver.dashboard') }}">
                                        <div class="group text-center">
                                            <div class="group-hover:cursor-pointer">Dashbord</div>
                                            <div
                                                class="block invisible bg-pr-400 w-12 h-1 rounded-md text-center -bottom-1 mx-auto relative group-hover:visible">
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <a href="{{ route('driver.profile') }}">
                                        <div class="group text-center">
                                            <div class="group-hover:cursor-pointer">Profile</div>
                                            <div
                                                class="block invisible bg-pr-400 w-8 h-1 rounded-md text-center -bottom-1 mx-auto relative group-hover:visible">
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <a href="{{ route('driver.trip') }}">
                                        <div class="group text-center">
                                            <div class="group-hover:cursor-pointer">Trip</div>
                                            <div
                                                class="block invisible bg-pr-400 w-16 h-1 rounded-md text-center -bottom-1 mx-auto relative group-hover:visible">
                                            </div>
                                    </a>
            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2024 <a
                            ...
                            class="hover:underline">Kitecareer™</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.facebook.com/kitecareer.kitecareer.5?mibextid=2JQ9oc" target='_blank' class="text-gray-500 hover:text-white">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M12 0C5.373 0 0 5.373 0 12c0 6.627 5.373 12 12 12s12-5.373 12-12c0-6.627-5.373-12-12-12zm2.148 6.025v1.582h-1.073c-.235 0-.494.294-.494.657v1.208h1.576v1.664h-1.576v4.214h-1.969v-4.214h-1.36v-1.664h1.36v-1.31c0-1.514 1.123-2.746 2.515-2.746h1.073z"/>
                        </svg>
                    </a>
                        <a href="https://twitter.com/KiteCareer2018" target='_blank' class="text-gray-500 hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <a href="https://www.linkedin.com/company/kitecareer/" target='_blank'
                            class="text-gray-500  hover:text-white">
                        ...
                        <a href="https://instagram.com/kitecareer2018/" target='_blank' class="text-gray-500 hover:text-white">
                        <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fill-rule="evenodd"
    ...
    <a href="javascript:void(0);" onclick="scrollToTop();"
        class="text-white fixed bottom-10 md:-right-0 -right-2">
...
<script>
    var scrollToTopButtonContainer = document.getElementById('scrollToTopButtonContainer');
